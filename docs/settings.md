...
With `socks.proxy_addr` set, server-side UDP relay is disabled until upstream SOCKS5 UDP ASSOCIATE support is implemented. TCP still uses the upstream proxy.
